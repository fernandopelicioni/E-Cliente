...
begin
           ...
           Panel2.Caption:='Versão do Produto : ' + EditVersao.caption + '   ';
end;
                            ...
                            if Eof then
                                 ...
                                 begin
                                         if DBLookupComboBox1.KeyValue = NULL then
                                               begin
                                                     ShowMessage('É necessário selecionar uma empresa!');
...
//                                                          ShowMessage('Há uma versão atualizada do software, nela, podem conter instruções fundamentais para o desempenho desta ferramenta');
