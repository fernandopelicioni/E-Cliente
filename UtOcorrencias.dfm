object FormOcorrencias: TFormOcorrencias
  Left = 0
  Top = 0
  ActiveControl = Button4
  Caption = 'Registro de Ocorrencias'
  ClientHeight = 459
  ClientWidth = 711
  Color = clBtnFace
    ...
    object TabEdicao: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object Enasc: TcxDBMaskEdit
          Left = 13
          Top = 113
          DataBinding.DataField = 'MCLI_DATA'
          DataBinding.DataSource = DtOco
        ...
        object CbTipo: TDBLookupComboBox
          ...
          Width = 234
          Height = 29
          DataField = 'MCLI_OCORRENCIA'
          DataSource = DtOco
          KeyField = 'CO_ID'
          ListField = 'CO_DES'
          ListSource = DtTipoOco
          TabOrder = 4
        end
  ...
  object QrOco: TFDQuery
    Connection = Pai.QrGenoma
    SQL.Strings = (
      'select * from tb_cli_ocorrencias'
      'where MCLI_CLIENTE=:cliente'
      '')
    Left = 484
    Top = 145
    ParamData = <
  ...
  object DtOco: TDataSource
    DataSet = QrOco
    Left = 528
    Top = 144
  end
  object DtTipoOco: TDataSource
    DataSet = QrTipoOco
    Left = 432
    Top = 240
  end
  object QrTipoOco: TFDQuery
    Connection = Pai.QrGenoma
    SQL.Strings = (
      'select * from tb_cli_CadOcorrencia')
    Left = 484
    Top = 233
  end
  object QrMovOco: TFDQuery
    IndexFieldNames = 'MCLI_CLIENTE'
    MasterSource = DtNewCliente
    MasterFields = 'CODIGO'
    Connection = Pai.QrGenoma
    SQL.Strings = (
      'select * from tb_cli_ocorrencias A'
      ''
      'join tb_cli_cadOcorrencia co on co.co_id = a.mcli_ocorrencia'
      '--where MCLI_CLIENTE=:cliente'
      'order by mcli_data desc')
    Left = 420
    Top = 297
  end
  object DtMovOco: TDataSource
    DataSet = QrMovOco
    Left = 464
    Top = 296
  end
